...
$router->group(['middleware' => 'web'], function ($router) {
    ...
    Route::group(['prefix' => 'api'], function () {
        ...
        // Notifications
        $router->get('/api/notifications/recent', 'NotificationController@recent');
        ...
        if (Spark::usesTeams()) {
            ...
            // Billing History...
            $router->put(
                    '/settings/' . $pluralTeamString . '/{team}/extra-billing-information', 'Settings\Teams\Billing\BillingInformationController@update'
            );
        ...
        // Billing History...
        $router->put(
                '/settings/extra-billing-information', 'Settings\Billing\BillingInformationController@update'
        );
