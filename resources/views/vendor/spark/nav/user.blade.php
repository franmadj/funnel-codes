    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container" v-if="user">
            <div class="navbar-header">
                <!-- Collapsed Hamburger -->
                <div class="hamburger">
                    <button type="button" class="navbar-toggle collapsed hamburger-button" data-toggle="collapse" data-target="#spark-navbar-collapse">
             ...
             <div class="collapse navbar-collapse" id="spark-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown" id="top-responsive-menu">
                        <!-- User Photo / Name -->
<!--                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li>
                                <a href="/tags">
                                    <i class="fa fa-fw fa-btn fa-tags" aria-hidden="true"></i>&nbsp;Manage Tags
                                </a>
                            </li>
            ...
            <div class="collapse navbar-collapse" id="spark-navbar-collapse-original">
                <!-- Left Side Of Navbar -->
                <ul class="nav navbar-nav">
                    @includeIf('spark::nav.user-left')
                </ul>
